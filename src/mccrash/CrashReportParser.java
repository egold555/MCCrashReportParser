...
import mccrash.CrashReport.IntCache;
import mccrash.CrashReport.Stacktrace;
import mccrash.CrashReport.SystemDetails;
import mccrash.CrashReport.SystemDetails.EnumModded;
import mccrash.CrashReport.SystemDetails.SystemDetailsBuilder;
...
public class CrashReportParser {
	...
	public static CrashReport parse(File f) throws FileNotFoundException, ParseException {
		...
		b.time(new SimpleDateFormat().parse(remove(s.nextLine(), "Time: ")));
